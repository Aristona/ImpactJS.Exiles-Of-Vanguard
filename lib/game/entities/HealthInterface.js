ig.module('game.entities.HealthInterface')
.requires('impact.game', 'impact.entity')
.defines(function() {
	EntityHealthInterface = ig.Entity.extend({
		...
		// Anim sheet
		animSheet: new ig.AnimationSheet( 'media/graphics/interfaces/healthstatus.png', 75, 75),
